...
COSMOS_DB_KEY = "3v3HRzxc3BpExkO6ZzlJeJ7WraI5qtZKjZJO3vguct0d5Jcug"
...
if __name__ == "__main__":
    ...
    # Ne conectăm la IP-ul de Gateway unde ESP32 ascultă
    client.connect("192.168.20.1", 8883)

    # Lansăm verificarea comenzilor (Polling) pe o "inimă" separată
    t = threading.Thread(target=polling_loop, daemon=True)
    t.start()

    # Thread-ul principal rămâne să asculte senzorii
    client.loop_forever()